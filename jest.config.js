...
const customJestConfig = {
  ...
  moduleNameMapper: {
    ...
    "^@tauri-apps/api/core$": "<rootDir>/__mocks__/@tauri-apps/api/core.ts",
    "^@tauri-apps/api/path$": "<rootDir>/__mocks__/@tauri-apps/api/path.ts",
    "^@tauri-apps/plugin-opener$": "<rootDir>/__mocks__/@tauri-apps/plugin-opener.ts",
    "^@tauri-apps/plugin-dialog$": "<rootDir>/__mocks__/@tauri-apps/plugin-dialog.ts",
  },
