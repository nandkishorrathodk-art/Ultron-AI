...
interface CustomizeUltronDialogProps {
  open: boolean;
...
export const CustomizeUltronDialog = ({
  open,
  onOpenChange,
}: CustomizeUltronDialogProps) => {
        ...
        <div className="flex-1 overflow-y-auto pb-3">
          <div className="space-y-5 pb-3">
            ...
            <div className="flex flex-col gap-2 px-1">
              <Label htmlFor="nickname">What should Ultron-AI call you?</Label>
              <TextareaAutosize
                id="nickname"
            ...
            <div className="flex flex-col gap-2 px-1">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <Label className="sm:flex-shrink-0">
                  What personality should Ultron-AI have?
                </Label>
            ...
            {/* Traits */}
            <div className="flex flex-col gap-2 px-1">
              <Label>What traits should Ultron-AI have?</Label>
            ...
            <div className="flex flex-col gap-3 px-1">
              <Label htmlFor="additional-info">
                Anything else Ultron-AI should know about you?
              </Label>
              <TextareaAutosize
                id="additional-info"
