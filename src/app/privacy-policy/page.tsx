...
export const metadata: Metadata = {
  title: "Privacy Policy | Ultron-AI",
  description:
    "Privacy Policy and data handling practices for Ultron-AI services.",
  openGraph: {
    title: "Privacy Policy | Ultron-AI",
    description:
      "Privacy Policy and data handling practices for Ultron-AI services.",
    ...
    <div className="px-4 py-8 pb-16 md:px-0">
      <div className="container mx-auto max-w-2xl space-y-6 rounded-md border bg-card px-4 py-8 shadow-lg sm:px-8">
        <h1 className="mb-5 text-center text-3xl font-semibold text-card-foreground">
          Ultron-AI Privacy Policy
        </h1>

        <div className="mt-4 text-lg leading-relaxed text-card-foreground">
          <p className="mb-6">
            Welcome to Ultron-AI. This Privacy Policy explains how Ultron-AI LLC
          ...
          <ul className="list-inside list-decimal">
            ...
            <li className="mb-3">
              ...
              individuals outside of Ultron-AI LLC except in the following
              circumstances:
            ...
            <li className="mb-3">
              ...
              <a
                href="https://help.Ultron-AI.co/en/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
              >
                https://help.Ultron-AI.co/en/
              </a>
            </li>
          </ul>
