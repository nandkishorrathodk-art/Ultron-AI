...
export const metadata: Metadata = {
  title: "Terms of Service | Ultron-AI",
  description: "Terms of Service and conditions for Ultron-AI services.",
  openGraph: {
    title: "Terms of Service | Ultron-AI",
    description: "Terms of Service and conditions for Ultron-AI services.",
    type: "website",
        ...
        <div className="mt-4 text-lg leading-relaxed text-card-foreground">
          <ol className="list-inside list-decimal">
            ...
            <li className="mb-3">
              ...
              harmless Ultron-AI LLC, its parent companies, and their respective
            ...
            <li className="mb-3">
              <strong>Changes to Terms of Service:</strong> Ultron-AI LLC
          ...
          <p className="mt-4">
            By using the Products provided by Ultron-AI LLC, you indicate your
