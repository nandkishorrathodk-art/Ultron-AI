...
export function captureFreeAgentValueReached({
  ...
  posthog.capture({
    distinctId: userId,
    event: "Ultron-AI-free_agent_value_reached",
    properties: {
      user_id: userId,
      chat_id: chatId,
      endpoint,
 ...
 * Ultron-AI-usage_cost grouped by distinct_id (or user_id).
 */
