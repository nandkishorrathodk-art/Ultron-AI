...
describe("selectModel", () => {
  ...
  describe("tier override for ask mode (paid users)", () => {
    it("should map Ultron-AI Pro to Sonnet 4.6 in ask mode", () => {
      expect(selectModel("ask", "ultra", "Ultron-AI-pro")).toBe(
        "model-sonnet-4.6",
      );
    });

    it("should map Ultron-AI Pro to Sonnet 4.6 for team users", () => {
      expect(selectModel("ask", "team", "Ultron-AI-pro")).toBe(
        "model-sonnet-4.6",
      );
    });

    it("should map Ultron-AI Standard to DeepSeek V4 Flash when no image/PDF", () => {
      expect(selectModel("ask", "pro", "Ultron-AI-standard")).toBe(
        "model-deepseek-v4-flash",
      );
    });

    it("should promote Ultron-AI Standard to Gemini 3 Flash when an image/PDF is attached", () => {
      expect(selectModel("ask", "pro", "Ultron-AI-standard", true)).toBe(
        "model-gemini-3-flash",
      );
    });

    it("should map Ultron-AI Max to Opus 4.6", () => {
      expect(selectModel("ask", "pro", "Ultron-AI-max")).toBe("model-opus-4.6");
    });
  });

  // Agent mode — Lite resolves to Kimi instead of Gemini
  describe("tier override in agent mode", () => {
    it("should map Ultron-AI Standard to Kimi K2.6 in agent mode", () => {
      expect(selectModel("agent", "pro", "Ultron-AI-standard")).toBe(
        "model-kimi-k2.6",
      );
    });

    it("should map Ultron-AI Pro to Sonnet 4.6 in agent mode", () => {
      expect(selectModel("agent", "pro", "Ultron-AI-pro")).toBe(
        "model-sonnet-4.6",
      );
    });

    it("should map Ultron-AI Max to Opus 4.6 in agent mode", () => {
      expect(selectModel("agent", "pro", "Ultron-AI-max")).toBe(
        "model-opus-4.6",
      );
    });
  ...
  describe("free user guard", () => {
    it("should ignore tier override for free users in agent mode", () => {
      expect(selectModel("agent", "free", "Ultron-AI-pro")).toBe(
        "agent-model-free",
      );
    });
