 ...
 * shapes:
 *   1. Underlying-model ids from before the Ultron-AI tier rebrand.
 *   2. `Ultron-AI-lite` from the short-lived first naming of the entry tier
 *      (renamed to `Ultron-AI-standard` because Lite mis-described Kimi K2.6).
 * Used by `coerceSelectedModel` to migrate values on read.
 */
export const LEGACY_MODEL_ID_MAP: Record<string, SelectedModel> = {
  "sonnet-4.6": "Ultron-AI-pro",
  "opus-4.6": "Ultron-AI-max",
  "gemini-3-flash": "Ultron-AI-standard",
  "kimi-k2.6": "Ultron-AI-standard",
  ...
  "grok-4.1": "Ultron-AI-standard",
  "grok-4.3": "Ultron-AI-standard",
  "Ultron-AI-lite": "Ultron-AI-standard",
};
